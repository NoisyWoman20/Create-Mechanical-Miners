...
public class BrassStressMinerMenu extends AbstractContainerMenu {
	private final BrassStressMinerBlockEntity blockEntity;

	public BrassStressMinerMenu(int containerId, Inventory playerInventory) {
		this(containerId, playerInventory, null);
	}

	public BrassStressMinerMenu(int containerId, Inventory playerInventory, @Nullable BrassStressMinerBlockEntity blockEntity) {
		super(CMMMenus.BRASS_STRESS_MINER_MENU.get(), containerId);
